...
function DataPrivacy() {
  ...
  const DataContainer = styled.div.attrs({ className: "n4d-container" })`
  ...
  return (
    <PageLayout background="var(--color-orchid)">
      <DataContainer>
        ...
        <p>
          Kemal Webersohn <span>{t("legal.dataPrivacy.generalInfo.officer.from")}</span> WS Datenschutz GmbH
        </p>
        <p>
        ...
        <p>
          ...
          {", "}
          <a href="https://de-de.facebook.com/full_data_use_policy">https://de-de.facebook.com/full_data_use_policy</a>
        </p>
        <p>
          ...
          <a href="https://www.instagram.com/about/legal/privacy/">https://www.instagram.com/about/legal/privacy/</a>
        </p>
        <p>
        ...
        <p>
          ...
          <a href="https://www.google.com/intl/de_de/help/terms_maps.html">
            <strong>https://www.google.com/intl/de_de/help/terms_maps.html</strong>
          </a>
        </p>
        ...
        <p>
          <strong>Fonticons, Inc.,6 Porter Road Apartment 3R, Cambridge, MA 02140, USA.</strong>
        </p>
        ...
        <p>
          ...
          <a href="https://eur-lex.europa.eu/eli/dec_impl/2021/914/oj?uri=CELEX%3A32021D0914&locale=en">
            <strong>https://eur-lex.europa.eu/eli/dec_impl/2021/914/oj?uri=CELEX%3A32021D0914&locale=en</strong>
          </a>
        </p>
        <p>
          <strong>
